...
export WIN32_AS_PROJECT_PATH := "C:\Praktyki\Analog\Analog"
...
export WIN32_AS_TEMP_PATH := "C:\Praktyki\Analog\Analog\Temp"
export WIN32_AS_BINARIES_PATH := "C:\Praktyki\Analog\Analog\Binaries"
...
ProjectMakeFile:
	...
	@'$(AS_BIN_PATH)/BR.AS.AnalyseProject.exe' '$(AS_PROJECT_PATH)/Analog.apj' -t '$(AS_TEMP_PATH)' -c '$(AS_CONFIGURATION)' -o '$(AS_BINARIES_PATH)'   -sfas -buildMode 'BuildAndTransfer'   
